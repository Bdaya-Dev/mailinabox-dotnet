...
namespace Bdaya.MailInABox.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", Bdaya.MailInABox.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}